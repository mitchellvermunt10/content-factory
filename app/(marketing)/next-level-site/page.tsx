...
export default function NextLevelSitePage() {
  return (
    <div className="relative bg-black text-white">
      ...
      <section className="relative overflow-hidden">
        {/* Cinematic background using the Trattoria Sole exterior */}
        ...
        <div className="relative mx-auto flex min-h-[88vh] max-w-6xl flex-col justify-between px-6 pb-20 pt-32 sm:px-10 sm:pt-40">
          <div>
            <p className="font-mono text-[10px] uppercase tracking-[0.4em] text-white/55 sm:text-xs">
              Premium tier · Next Level Sites
            </p>
            ...
            <p className="mt-8 max-w-2xl text-pretty text-lg text-white/70 sm:text-xl">
              Een cinematische website voor lokale ondernemers. Camera door je
            ...
            <div className="mt-12 flex flex-wrap gap-3">
              ...
              <a
                href="mailto:mitchell.vermunt@gmail.com?subject=Demo-call Next Level Site"
          ...
          >
            ...
            <div className="relative aspect-[16/9] overflow-hidden">
              ...
              <div className="absolute inset-x-0 bottom-0 p-8 sm:p-12">
                ...
                <p className="mt-3 font-serif text-3xl sm:text-5xl">Trattoria Sole</p>
      ...
      <section className="relative border-t border-white/10 px-6 py-24 sm:py-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-6 font-serif text-4xl font-light leading-tight tracking-tight md:text-5xl">
            ...
            <br />
            <span className="text-white/70">Eén persoon die het echt geeft.</span>
          </h2>
          ...
          <div className="mt-16 grid gap-4 lg:grid-cols-3 lg:gap-6">
            ...
            <div className="rounded-3xl border border-white/10 bg-black p-8 sm:p-10">
              ...
              <p className="mt-2 text-sm text-white/55">
                Complete cinematic website. Geen abonnement.
              </p>
              <ul className="mt-8 space-y-3 text-sm text-white/70">
                {[
              ...
              <a
                href="mailto:mitchell.vermunt@gmail.com?subject=Next Level Site eenmalig"
            ...
            <div className="relative rounded-3xl border-2 border-accent/50 bg-accent/[0.06] p-8 sm:p-10 lg:-mt-4 lg:mb-4">
              ...
              <a
                href="mailto:mitchell.vermunt@gmail.com?subject=Always-On Next Level Site"
            ...
            <div className="rounded-3xl border border-white/10 bg-black p-8 sm:p-10">
              ...
              <a
                href="mailto:mitchell.vermunt@gmail.com?subject=AI Receptionist"
                className="mt-10 flex w-full items-center justify-center gap-2 rounded-full border border-white/20 px-5 py-3.5 text-sm font-medium transition-colors hover:bg-white/10"
              >
                Meer info
                <ArrowRight className="size-4" />
